...
public class ApplyBuilder<A, B> {
    ...
    public class ApplyBuilder3<C> {
        ...
        public <D> Taker<D> skipThen(Taker<D> pd) { return attempt(allSkipped().skipThen(pd)); }
        ...
        public class ApplyBuilder4<D> {
            ...
            public <E> Taker<E> skipThen(Taker<E> pe) { return attempt(allSkipped().skipThen(pe)); }
            ...
            public class ApplyBuilder5<E> {
                ...
                public <G> Taker<G> skipThen(Taker<G> pg) { return attempt(allSkipped().skipThen(pg)); }
                ...
                public class ApplyBuilder6<G> {
                    ...
                    public <H> Taker<H> skipThen(Taker<H> ph) { return attempt(allSkipped().skipThen(ph)); }
                    ...
                    public class ApplyBuilder7<H> {
                        ...
                        public <J> Taker<J> skipThen(Taker<J> pj) { return attempt(allSkipped().skipThen(pj)); }
                        ...
                        public class ApplyBuilder8<J> {
                            ...
                            public <K> Taker<K> skipThen(Taker<K> pk) { return attempt(allSkipped().skipThen(pk)); }
