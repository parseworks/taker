...
public class ApplyBuilder<A, B> {
    ...
    public class ApplyBuilder3<C> {
        ...
        public <R> Taker<R> map(Func3<A, B, C, R> f) { return map(a -> b -> c -> f.apply(a, b, c)); }
        ...
        public class ApplyBuilder4<D> {
            ...
            public <R> Taker<R> map(Func4<A, B, C, D, R> f) { return map(a -> b -> c -> d -> f.apply(a, b, c, d)); }
            ...
            public class ApplyBuilder5<E> {
                ...
                public <R> Taker<R> map(Func5<A, B, C, D, E, R> f) { return map(a -> b -> c -> d -> e -> f.apply(a, b, c, d, e)); }
                ...
                public class ApplyBuilder6<G> {
                    ...
                    public <R> Taker<R> map(Func6<A, B, C, D, E, G, R> f) { return map(a -> b -> c -> d -> e -> g -> f.apply(a, b, c, d, e, g)); }
                    ...
                    public class ApplyBuilder7<H> {
                        ...
                        public <R> Taker<R> map(Func7<A, B, C, D, E, G, H, R> f) { return map(a -> b -> c -> d -> e -> g -> h -> f.apply(a, b, c, d, e, g, h)); }
                        ...
                        public class ApplyBuilder8<J> {
                            ...
                            public <R> Taker<R> map(Func8<A, B, C, D, E, G, H, J, R> f) { return map(a -> b -> c -> d -> e -> g -> h -> j -> f.apply(a, b, c, d, e, g, h, j)); }
