...
final class Inputs {
    ...
    private static class LowercaseInput implements Input {

        private final Input delegate;

        private LowercaseInput(Input delegate) {
    ...
    private static final class LowercaseTextInput extends LowercaseInput implements TextInput {

        private final TextInput delegate;

        private LowercaseTextInput(TextInput delegate) {
            super(delegate);
            this.delegate = delegate;
        }
    ...
    private static class UppercaseInput implements Input {

        private final Input delegate;

        private UppercaseInput(Input delegate) {
            this.delegate = delegate;
        }
    ...
    private static final class UppercaseTextInput extends UppercaseInput implements TextInput {

        private final TextInput delegate;

        private UppercaseTextInput(TextInput delegate) {
            super(delegate);
            this.delegate = delegate;
        }
